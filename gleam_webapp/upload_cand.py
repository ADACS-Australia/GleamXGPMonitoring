...
def upload_candidate(fits_files, image_gif_directory):
    ...
    for fits_path in fits_files:
        ...
        for cand in hdul[1].data:
            ...
            base_path = f'{image_gif_directory}/{data["obs_id"]}_{data["filter"]}_{data["cand_id"]:03d}'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_directory", type=str, help="Path to directory containing all of the gifs and images.")
    parser.add_argument(
        "--fits",
        type=str,
