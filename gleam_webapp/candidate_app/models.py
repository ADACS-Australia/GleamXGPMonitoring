...
class Observation(models.Model):
    ...
    frequency_channels = models.CharField(
        max_length=128, blank=True, null=True, verbose_name="Frequency Channels (x1.28 MHz)"
    )
...
class Candidate(models.Model):
    ...
    nks_ra_hms = models.CharField(
        max_length=32, blank=True, null=True, verbose_name="Nearest known source Right Acension (HH:MM:SS)"
    )
    nks_dec_dms = models.CharField(
        max_length=32, blank=True, null=True, verbose_name="Nearest known source Declination (DD:MM:SS)"
    )
